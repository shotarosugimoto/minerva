...
initial_addinformation = input('(optional) Write your additional information : ')

initial_information = ""
if initial_addinformation:
    initial_information += "Additional information provided by the user: " + initial_addinformation

# decide_goalの処理
# 一番大きいアウトラインまで完成する
decide_goal = DecideGoal(openai_api_key=openai_api_key, goal=initial_goal, information=initial_information)
new_goal, tokens= decide_goal.redefine_goal()
